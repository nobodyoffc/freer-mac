...
status: Phases 1–6 complete; Phase 7 (Wallet) at 7.6.3 — contacts carve on-chain (FEIP CONTACT add/update/delete) + deletion-aware sync shipped; 7.6 closed, next is 7.7 (QR)
