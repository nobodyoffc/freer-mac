...
status: Phases 1–6 complete; Phase 7 (Wallet) at 7.6.2b — on-chain contact sync (fetch + decrypt carved CONTACT records) shipped, next is 7.6.3 (on-chain carve via FEIP CONTACT) or 7.7 (QR)
