...
status: Phases 1–6 complete; Phase 7 (Wallet) at 7.8 — person menu (toolbar avatar → identity-role popover: main/master/watched/multisig/servant switching), add-watched-FID flow, and watch-only Send fallback (`RawTxInfo` export via copy/file/multi-part QR) shipped; next is Phase 8
