...
status: Phases 1–7 complete; Phase 8 at 8.2 — Secrets pane (Pattern B cipher-only vault, FEIP `Secret` sn 17 carve/sync, TOTP authenticator tab) shipped on top of 8.1's Tools pane; next is 8.3 (application/token/proof/protocol lifecycle)
